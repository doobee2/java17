...
public class StringEx1 {
    public static void main(String[] args) {
        String str1 = new String("LeeSeulBee");
        String str2 = "leeseulbee";
        ...
        printArr(bArr);
        //두 번째 방법 : Arrays.toString(배열명) 사용 (자바1.6이상에서 사용)
        char[] cArr = new char[bArr.length];
        for(int i=0; i<bArr.length; i++){
            cArr[i] = (char) bArr[i];
        }
        System.out.println(Arrays.toString(cArr));
        System.out.println("i는 몇 번째? "+(str1.indexOf("u")));  //특정문자의 인덱스 구하기
        ...
        String data1 = str1.replace("S","G");
        System.out.println("S를 G로 변경 : "+data1);
        String str3 = "         My name is SeulBee, Lee         ";
