...
public class Example2 {
    public static void main(String[] args) {
        ...
        if(조건식1) {
            ...
            조건식2가 만족하지 않고, 조건식3가 만족할 경우 실행할 문장
        }.....
        } else {
        ...
        //else if 활용 없이 if구문만 사용했을 때 (비효율적)
        ...
        ** 기준식 또는 변수의 결과값의 case의 값과 경우의 수가 같아야하고,
           경우의 수가 같지 않은 경우 반드시 default를 설정하여야 하며,
           case의 종료는 break로 해야하며, break가 지정되지 않으면,
           아래 case의 연산까지 모두 진행하게 됨
        */
        switch (pt){
            case 1:
            case 2:
